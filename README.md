...
[GraphViz](https://graphviz.org/Gallery/directed/) diagrams are supported (dot/plantuml - see [plugin](https://github.com/manastalukdar/markdown-it-textual-uml)). Unfortunately [Mermaid](https://mermaid.js.org/) diagrams seem to be broken by the Unreal Web Brower limitations.
